...
/**
 * Author：Created by shihongfei on 2019/10/8 20:17
 * Email：1511808259@qq.com
 */
public class PendingReceiptAdapter extends BaseQuickAdapter<DoQueryOrdersDetailsData, BaseViewHolder> {
    public PendingReceiptAdapter(int layoutResId, @Nullable List<DoQueryOrdersDetailsData> data) {
