...
import com.hjkj.fuduoduo.kefu.ContextMenuActivity;
...
public class ChatRowTrack extends ChatRow {
    ...
    protected void onSetUpView() {
        ...
        if (!TextUtils.isEmpty(imageUrl)) {
            Glide.with(context).load(imageUrl).apply(new RequestOptions().diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(com.hyphenate.helpdesk.R.drawable.hd_default_image)).into(mImageView);
        }
    }
