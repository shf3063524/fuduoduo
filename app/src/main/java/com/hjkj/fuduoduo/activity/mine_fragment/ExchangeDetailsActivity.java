...
public class ExchangeDetailsActivity extends BaseActivity {
    ...
    private ExchangeDetailsAdapter mOrderDetailsAdapter;
    ...
    private void initRecyclerView() {
        ...
        mOrderDetailsAdapter = new ExchangeDetailsAdapter(R.layout.item_exchange_details, mOrderDetailsData);
        // mAdapter.openLoadAnimation(BaseQuickAdapter.SCALEIN);
        // mAdapter.isFirstOnly(true);
        LinearLayoutManager layoutManager = new LinearLayoutManager(ExchangeDetailsActivity.this);
