 ...
 * 申请退款-我要退货退款页面
 */
public class RequestARefund02Activity extends BaseActivity {
    ...
    public static void openActivity(Context context) {
        Intent intent = new Intent(context, RequestARefund02Activity.class);
        context.startActivity(intent);
    }

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_request_a_refund02;
    }
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new ChooseImageAdapter(RequestARefund02Activity.this, onAddPicClickListener);
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position1, long l) {
                            switch (items[position1]) {
                                case "相册":
                                    ...
                                    break;
                                case "拍照":
                                    PictureSelector.create(RequestARefund02Activity.this)
                ...
                if (selectMediaCustomer.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(RequestARefund02Activity.this).themeStyle(R.style.picture_QQ_style).openExternalPreview(position, selectMediaCustomer);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(RequestARefund02Activity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(RequestARefund02Activity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
    ...
    @OnClick({R.id.m_iv_arrow, R.id.m_layout_reason_for_return})
