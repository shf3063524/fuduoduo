...
/**
 * 海外精选页面
 * Author：Created by shihongfei on 2019/9/26 14:06
 * Email：1511808259@qq.com
 */
public class OverseasActivity extends BaseActivity implements ObservableScrollView.ScrollViewListener {
    ...
    public static void openActivity(Context context) {
        Intent intent = new Intent(context, OverseasActivity.class);
    ...
    private void initRecyclerView() {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(OverseasActivity.this, 2, GridLayoutManager.VERTICAL, false) {
            @Override
    ...
    private void initListener() {
        ...
        treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollView.setScrollViewListener(OverseasActivity.this);
    ...
    protected void actionView() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ProductDetailsActivity.openActivity(OverseasActivity.this);
            }
        });
    }
