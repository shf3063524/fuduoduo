 ...
 * 新人专享福利页面
 */
public class NewcomerExclusiveBenefitsActivity extends BaseActivity {
    ...
    @BindColor(R.color.cl_e54848)
    int cl_e54848;
    @BindColor(R.color.cl_f46a69)
    int cl_f46a69;
    ...
    public static void openActivity(Context context) {
        Intent intent = new Intent(context, NewcomerExclusiveBenefitsActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_newconmer_exclusive_benefits;
    }
    ...
    private void initRecyclerView() {
        ...
        GridLayoutManager gridLayoutManagerRecommendedToYou = new GridLayoutManager(NewcomerExclusiveBenefitsActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
        ...
        GridLayoutManager gridLayoutManagerValueExplosion = new GridLayoutManager(NewcomerExclusiveBenefitsActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
            public boolean canScrollVertically() {
                return false;
            }
        ...
        GridLayoutManager gridLayoutManagerProducts = new GridLayoutManager(NewcomerExclusiveBenefitsActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
            public boolean canScrollVertically() {
                return false;
            }
        ...
        GridLayoutManager gridLayoutManagerGoods = new GridLayoutManager(NewcomerExclusiveBenefitsActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
            public boolean canScrollVertically() {
                return false;
            }
        ...
        GridLayoutManager gridLayoutManagerSemiFinished = new GridLayoutManager(NewcomerExclusiveBenefitsActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
            public boolean canScrollVertically() {
                return false;
            }
    ...
    protected void actionView() {
        ...
        mRecommendedToYouAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ProductDetailsActivity.openActivity(NewcomerExclusiveBenefitsActivity.this);
            }
        });
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.m_layout_one: // 为你推荐
                mLayoutOne.setBackgroundColor(cl_e54848);
                mLayoutTwo.setBackgroundColor(cl_f46a69);
                mLayoutThree.setBackgroundColor(cl_f46a69);
                mLayoutFour.setBackgroundColor(cl_f46a69);
                mLayoutFive.setBackgroundColor(cl_f46a69);
                //滚动到顶部
            ...
            case R.id.m_layout_two: // 超值爆款
                mLayoutOne.setBackgroundColor(cl_f46a69);
                mLayoutTwo.setBackgroundColor(cl_e54848);
                mLayoutThree.setBackgroundColor(cl_f46a69);
                mLayoutFour.setBackgroundColor(cl_f46a69);
                mLayoutFive.setBackgroundColor(cl_f46a69);
                //超值爆款
            ...
            case R.id.m_layout_three: // 美妆穿搭
                mLayoutOne.setBackgroundColor(cl_f46a69);
                mLayoutTwo.setBackgroundColor(cl_f46a69);
                mLayoutThree.setBackgroundColor(cl_e54848);
                mLayoutFour.setBackgroundColor(cl_f46a69);
                mLayoutFive.setBackgroundColor(cl_f46a69);
                //滚动到美妆穿搭
                mScrollView.post(new Runnable() {
            ...
            case R.id.m_layout_four: // 居家日用
                ...
                mLayoutTwo.setBackgroundColor(cl_f46a69);
                mLayoutThree.setBackgroundColor(cl_f46a69);
                mLayoutFour.setBackgroundColor(cl_e54848);
                mLayoutFive.setBackgroundColor(cl_f46a69);
                //滚动到居家日用
                mScrollView.post(new Runnable() {
                    @Override
            ...
            case R.id.m_layout_five: // 厨卫家电
                ...
                mLayoutThree.setBackgroundColor(cl_f46a69);
                mLayoutFour.setBackgroundColor(cl_f46a69);
                mLayoutFive.setBackgroundColor(cl_e54848);
                //滚动到厨卫家电
                mScrollView.post(new Runnable() {
                    @Override
                    public void run() {
