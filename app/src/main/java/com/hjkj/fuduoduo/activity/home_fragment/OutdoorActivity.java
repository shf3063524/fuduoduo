...
/**
 * 户外活动页面
 * Author：Created by shihongfei on 2019/9/26 14:02
 * Email：1511808259@qq.com
 */
public class OutdoorActivity extends BaseActivity implements ObservableScrollView.ScrollViewListener {
    ...
    private void initRecyclerView() {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(OutdoorActivity.this, 2, GridLayoutManager.VERTICAL, false) {
            @Override
    ...
    private void initListener() {
        ...
        treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollView.setScrollViewListener(OutdoorActivity.this);
    ...
    protected void actionView() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ProductDetailsActivity.openActivity(OutdoorActivity.this);
            }
        });
    }
