...
/**
 * 差旅预定-页面
 * Author：Created by shihongfei on 2019/9/26 15:52
 * Email：1511808259@qq.com
 */
public class TravelActivity extends BaseActivity implements ObservableScrollView.ScrollViewListener {
    ...
    private void initListener() {
        ...
        treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollView.setScrollViewListener(TravelActivity.this);
    ...
    protected void actionView() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ProductDetailsActivity.openActivity(TravelActivity.this);
            }
        });
    }
