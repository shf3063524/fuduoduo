...
import com.hjkj.fuduoduo.activity.mine_fragment.ApplyForAfterSaleActivity;

public class ReasonForReturn02Dialog extends Dialog implements View.OnClickListener {
    ...
    public ReasonForReturn02Dialog(@NonNull Context context) {
        super(context, R.style.ActionSheetDialogStyle);
        this.context = context;
    }

    public ReasonForReturn02Dialog setListener(OnClickListener listener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reason_for_return02_dialog);
