 ...
 * 修改申请-售后跳转
 */
public class ModifyApplication02Activity extends BaseActivity {
    ...
    public static void openActivity(Context context, DoqueryreturnordersData doqueryreturnordersData) {
        Intent intent = new Intent(context, ModifyApplication02Activity.class);
    ...
    private void onProcessingData(DoqueryreturnordersData data) {
        // 规格图片
        GlideUtils.loadImage(ModifyApplication02Activity.this, data.getReturnDetailsList().getSpecification().getSpecificationImage(), R.drawable.ic_all_background, mIvShopping);
        // 商品名称
        mTvContent.setText(data.getReturnDetailsList().getCommodity().getName());
        // 规格
        mTvSpecification.setText(data.getReturnDetailsList().getSpecification().getCommoditySpecification());
        // 退款金额
        mTvRefundAmount.setText(DoubleUtil.double2Str(data.getOrder().getActualPrice()));
        // 提示
        mTvPrompt.setText("最多" + DoubleUtil.double2Str(data.getOrder().getActualPrice()) + "积分，含发货邮费" + DoubleUtil.double2Str(data.getFreightPrice()) + "积分");
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new ChooseImageAdapter(ModifyApplication02Activity.this, onAddPicClickListener);
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position1, long l) {
                            switch (items[position1]) {
                                case "相册":
                                    ...
                                    break;
                                case "拍照":
                                    PictureSelector.create(ModifyApplication02Activity.this)
                ...
                if (selectMediaCustomer.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(ModifyApplication02Activity.this).themeStyle(R.style.picture_QQ_style).openExternalPreview(position, selectMediaCustomer);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(ModifyApplication02Activity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(ModifyApplication02Activity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.m_layout_symbol: // 退款原因
                new ReasonForReturn02Dialog(ModifyApplication02Activity.this)
            ...
            case R.id.m_tv_submit: // 提交
                if ("请选择".equals(getTextString(mTvReasonForReturn))) {
                    Toasty.info(ModifyApplication02Activity.this, "请选择退款原因").show();
                    return;
                }
        ...
        OkGo.<AppResponse>post(Api.ORDERS_DOMODIFYRETURNORDER)//
                ...
                .execute(new DialogCallBack<AppResponse>(this, "正在提交...") {
                    ...
                    public void onSuccess(AppResponse simpleResponseAppResponse) {
                        if (simpleResponseAppResponse.isSucess()) {
                            AfterSaleActivity.openActivity(ModifyApplication02Activity.this);
                            finish();
                        }
                    }
                });
