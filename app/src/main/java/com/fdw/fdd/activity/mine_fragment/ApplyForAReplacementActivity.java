...
public class ApplyForAReplacementActivity extends BaseActivity {
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new ChooseImageAdapter(ApplyForAReplacementActivity.this, onAddPicClickListener);
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position1, long l) {
                            switch (items[position1]) {
                                case "相册":
                                    ...
                                    break;
                                case "拍照":
                                    PictureSelector.create(ApplyForAReplacementActivity.this)
                ...
                if (selectMediaCustomer.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(ApplyForAReplacementActivity.this).themeStyle(R.style.picture_QQ_style).openExternalPreview(position, selectMediaCustomer);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(ApplyForAReplacementActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(ApplyForAReplacementActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
