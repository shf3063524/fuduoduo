...
public class ElectricApplianceNewcomerActivity extends BaseActivity {
    ...
    @BindColor(R.color.cl_1e339b)
    int cl_1e339b;
    @BindColor(R.color.cl_5965d6)
    int cl_5965d6;
    ...
    public static void openActivity(Context context) {
        Intent intent = new Intent(context, ElectricApplianceNewcomerActivity.class);
        context.startActivity(intent);
    }

    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_electric_appliance_newcomer;
    }
    ...
    private void initRecyclerView() {
        ...
        GridLayoutManager gridLayoutManagerRecommendedToYou = new GridLayoutManager(ElectricApplianceNewcomerActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
        ...
        GridLayoutManager gridLayoutManagerValueExplosion = new GridLayoutManager(ElectricApplianceNewcomerActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
            public boolean canScrollVertically() {
                return false;
            }
        ...
        GridLayoutManager gridLayoutManagerProducts = new GridLayoutManager(ElectricApplianceNewcomerActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
            public boolean canScrollVertically() {
                return false;
            }
        ...
        GridLayoutManager gridLayoutManagerGoods = new GridLayoutManager(ElectricApplianceNewcomerActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
            public boolean canScrollVertically() {
                return false;
            }
        ...
        GridLayoutManager gridLayoutManagerSemiFinished = new GridLayoutManager(ElectricApplianceNewcomerActivity.this, 3, GridLayoutManager.VERTICAL, false) {
            @Override
            public boolean canScrollVertically() {
                return false;
            }
    ...
    protected void actionView() {
        ...
        mRecommendedToYouAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ProductDetailsActivity.openActivity(ElectricApplianceNewcomerActivity.this);
            }
        });
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.m_layout_one: // 为你推荐
                mLayoutOne.setBackgroundColor(cl_1e339b);
                mLayoutTwo.setBackgroundColor(cl_5965d6);
                mLayoutThree.setBackgroundColor(cl_5965d6);
                mLayoutFour.setBackgroundColor(cl_5965d6);
                mLayoutFive.setBackgroundColor(cl_5965d6);
                //滚动到顶部
            ...
            case R.id.m_layout_two: // 超值爆款
                mLayoutOne.setBackgroundColor(cl_5965d6);
                mLayoutTwo.setBackgroundColor(cl_1e339b);
                mLayoutThree.setBackgroundColor(cl_5965d6);
                mLayoutFour.setBackgroundColor(cl_5965d6);
                mLayoutFive.setBackgroundColor(cl_5965d6);
                //超值爆款
            ...
            case R.id.m_layout_three: // 美妆穿搭
                mLayoutOne.setBackgroundColor(cl_5965d6);
                mLayoutTwo.setBackgroundColor(cl_5965d6);
                mLayoutThree.setBackgroundColor(cl_1e339b);
                mLayoutFour.setBackgroundColor(cl_5965d6);
                mLayoutFive.setBackgroundColor(cl_5965d6);
                //滚动到美妆穿搭
                mScrollView.post(new Runnable() {
            ...
            case R.id.m_layout_four: // 居家日用
                ...
                mLayoutTwo.setBackgroundColor(cl_5965d6);
                mLayoutThree.setBackgroundColor(cl_5965d6);
                mLayoutFour.setBackgroundColor(cl_1e339b);
                mLayoutFive.setBackgroundColor(cl_5965d6);
                //滚动到居家日用
                mScrollView.post(new Runnable() {
                    @Override
            ...
            case R.id.m_layout_five: // 厨卫家电
                ...
                mLayoutThree.setBackgroundColor(cl_5965d6);
                mLayoutFour.setBackgroundColor(cl_5965d6);
                mLayoutFive.setBackgroundColor(cl_1e339b);
                //滚动到厨卫家电
                mScrollView.post(new Runnable() {
                    @Override
                    public void run() {
