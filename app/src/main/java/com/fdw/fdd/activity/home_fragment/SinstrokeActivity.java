...
/**
 * 防暑降温页面
 * Author：Created by shihongfei on 2019/9/26 15:48
 * Email：1511808259@qq.com
 */
public class SinstrokeActivity extends BaseActivity implements ObservableScrollView.ScrollViewListener {
    ...
    public static void openActivity(Context context) {
        Intent intent = new Intent(context, SinstrokeActivity.class);
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_sinstroke;
    }
    ...
    private void initListener() {
        ...
        treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                scrollView.setScrollViewListener(SinstrokeActivity.this);
    ...
    protected void actionView() {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ProductDetailsActivity.openActivity(SinstrokeActivity.this);
            }
        });
    }
